        ...
        <CRow className="justify-content-center mt-5">
          <CCol md={8} lg={9} xl={10} className="mt-5">
            ...
            <div className="mb-3">
              ...
              All content, features, and functionality are the exclusive property of Axleshift HR 2
              and are protected by copyright, trademark, and other intellectual property laws.
            </div>
            <div className="mb-3">
              <h3>Limitation of Liability</h3>
              Axleshift HR 2 shall not be liable for any direct, indirect, incidental, or
