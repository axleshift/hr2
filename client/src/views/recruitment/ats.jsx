  ...
  return (
    <CContainer className="d-flex flex-column gap-4 mb-3">
      ...
      <CRow>
        <CContainer>
          <CCard>
            <CCardHeader>In-progress Applications</CCardHeader>
            <CCardBody>List</CCardBody>
          </CCard>
        </CContainer>
      </CRow>
      <CRow>
        <CContainer>
          <CCard>
            <CCardHeader>Recent Job Postings</CCardHeader>
            <CCardBody>List</CCardBody>
          </CCard>
        </CContainer>
      </CRow>
      <CRow>
        <CContainer>
          <CCard>
            <CCardHeader>Recent Applicants</CCardHeader>
            <CCardBody>List</CCardBody>
          </CCard>
        </CContainer>
      </CRow>
