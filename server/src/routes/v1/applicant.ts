...
const router = Router();
import { addNewResume, getAllResumeData, getResumeById, deleteResume, updateResume, searchResume, getResumeFile } from "../../database/v1/controllers/applicantController";
