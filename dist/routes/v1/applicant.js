...
}), applicantController_1.addNewResume);
router.put("/:id", (0, verifySession_1.default)({
    permissions: ["admin", "superadmin"],
}), applicantController_1.updateResume);
router.get("/all", (0, verifySession_1.default)({
    permissions: ["admin", "superadmin"],
}), applicantController_1.getAllResumeData);
...
router.get("/download/:id", (0, verifySession_1.default)({
    permissions: ["admin", "superadmin"],
}), applicantController_1.getResumeFile);
router.get("/search", (0, verifySession_1.default)({
    permissions: ["admin", "superadmin"],
}), applicantController_1.searchResume);
router.get("/:id", (0, verifySession_1.default)({
    permissions: ["admin", "superadmin"],
}), applicantController_1.getResumeById);
router.delete("/:id", (0, verifySession_1.default)({
    permissions: ["admin", "superadmin"],
}), applicantController_1.deleteResume);
exports.default = {
    metadata: {
        path: "/applicant",
        method: ["POST", "GET"],
